...
Moreover, we will use popular Python libraries such as Tensorflow, Keras and Machine Learning techniques such as Adam Optimizer to train the ANN model and predict the churn rates.
  ...
  - DATA: Customer Data: <a href = "https://github.com/Pythutty/churn-analysis/blob/main/Data/Artificial_Neural_Network_Case_Study_data.csv">View here</a>
  - Python Notebook: <a href = "https://github.com/Pythutty/churn-analysis/blob/main/Notebooks/Project.ipynb"> View here</a>
